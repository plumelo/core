  ...
  neovim = neovim.override {
    configure = {
      customRC = ''
        ...
        nnoremap <silent> =- :call Externalize('${self.alacritty}/bin/alacritty -t "ranger-menu" -e sh -c "ranger --choosefiles=%s --selectfile='.expand("%:p").' '.expand("%:p:h").' && clear"; sleep 0.01',':silent ::e! ')<CR>
